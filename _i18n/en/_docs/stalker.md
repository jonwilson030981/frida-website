...
## Basic Operation
Code can be thought of as a series of blocks of instructions [PJ: you are talking about Basic Blocks here]. Each block starts with an optional series of instructions [PJ: Optional?] which run in sequence. And ends when we encounter an instruction which causes (or can cause) execution to continue with an instruction other than the one immediately following it in memory.
...
### Sysenter Virtualization [PJ: Did you mean sysenter? or syscall?]
